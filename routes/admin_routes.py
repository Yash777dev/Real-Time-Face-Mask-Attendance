...
from database.models import db, Admin, Student, FaceEmbedding, Attendance, AttendanceLog
from utils.decorators import admin_required
from utils.validators import validate_student_form
from utils.helpers import get_face_images, delete_student_files
...
def students():
    ...
    # Get embedding counts per student
    embedding_counts = {}
...
def delete_student(student_id):
    ...
    try:
        ...
        # Delete from DB (cascade deletes embeddings and attendance)
        db.session.delete(student)
        db.session.commit()
        
        logger.info(f"🗑️ Student deleted: {name}")
