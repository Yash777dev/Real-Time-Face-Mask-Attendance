...
from database.models import db, Attendance, AttendanceLog, Student, FaceEmbedding
...
class AttendanceService:
    ...
    def __init__(self, face_detector=None, face_recognizer=None, mask_detector=None):
        ...
        self.cooldown_seconds = 5  # Prevent rapid re-recognition
    ...
    def start_camera(self, source=0):
        ...
        with self.lock:
            ...
            # Reset today's recognition cache
            self.recognized_today = set()
            self.last_recognition = {}
    ...
    def process_frame(self, frame):
        ...
        try:
            ...
            for face in faces:
                ...
                # Step 4: Generate Embedding (ArcFace)
                embedding = None
                ...
                if embedding is not None and len(self.student_embeddings) > 0:
                    ...
                    if match['match'] and match['student_id'] is not None:
                        ...
                        if student:
                            ...
                            # Step 6: Check today's attendance and mark
    ...
    def _try_mark_attendance(self, student_id, confidence, mask_detected):
        ...
        Uses cooldown to prevent rapid duplicate attempts
        """
    ...
    def get_department_stats():
        """Get attendance by department for chart"""
        today = date.today()
