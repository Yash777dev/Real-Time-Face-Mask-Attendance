...
from backend.database.models import db, Student, FaceEmbedding, Attendance
from backend.utils.decorators import admin_required, api_login_required
from backend.utils.helpers import save_base64_image, get_student_face_folder
...
def capture_image():
    ...
    image_type = data.get('image_type', 'normal')
...
def generate_embeddings(student_id):
    ...
    from backend.app import get_face_recognizer
...
def api_delete_student(student_id):
    ...
    try:
        from backend.utils.helpers import delete_student_files
